...
class ProjectData {
  static final projects = [
    ...
    Project(
      ...
      imageUrl: AppAssets.projectDarvasa,
      screenshots: [
        AppAssets.projectDarvasa01,
        AppAssets.projectDarvasa02,
        AppAssets.projectDarvasa03,
        AppAssets.projectDarvasa04,
        AppAssets.projectDarvasa05,
      ],
      codeUrl: '',
      demoUrl: '',
      types: [ProjectType.website, ProjectType.mobile, ],
      readmeFilePath: 'assets/projects/darvasa/darvasa_readme.md',
    ),
    ...
    Project(
      ...
      technologies: ['Flutter', 'Supabase', 'Drift', 'Dart', 'Riverpod', 'RazorPay', 'Firebase Notification', 'Crashlytics', ],
      imageUrl: AppAssets.projectSellora,
      screenshots: [],
      codeUrl: 'https://github.com/BackershanT/sellora_pos',
      demoUrl: '',
      types: [ProjectType.website, ProjectType.mobile],
      readmeFilePath: 'assets/projects/sellora/sellora_readme.md',
    ),
     Project(
      id: '18',
      title: 'Mahallu Management System',
      description: 'A comprehensive multi-tenant Mahallu Management System...',
      technologies: ["React 19","TypeScript","Vite","Firebase","Tailwind CSS 4"],
      imageUrl: AppAssets.projectMahalluManagement,
      screenshots: [      
        AppAssets.projectMahalluManagement01,
        AppAssets.projectMahalluManagement02,
        AppAssets.projectMahalluManagement03,
        AppAssets.projectMahalluManagement04,
        AppAssets.projectMahalluManagement05,
        AppAssets.projectMahalluManagement06,
        AppAssets.projectMahalluManagement07,
        AppAssets.projectMahalluManagement08,],
      codeUrl: 'https://github.com/BackershanT/mahallu',
      demoUrl: 'https://mahallums.netlify.app/',
      types: [ProjectType.website, ProjectType.mobile],
      readmeFilePath: 'assets/projects/mahallu_management/mahallu_management_readme.md',
    ),
