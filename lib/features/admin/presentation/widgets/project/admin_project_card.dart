...
import 'package:my_protfolio/features/admin/presentation/widgets/project/admin_project_card_cover.dart';
    ...
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        child: Column(
          ...
          children: [
            AdminProjectCardCover(
              project: p,
              onTapScreenshots: () => _openScreenshots(context),
