...
/// Styled search bar and technology filter chip row for projects.
class AdminProjectSearchBar extends StatefulWidget {
  ...
  @override
  State<AdminProjectSearchBar> createState() => _AdminProjectSearchBarState();
}

class _AdminProjectSearchBarState extends State<AdminProjectSearchBar> {
        ...
        SizedBox(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              hintText: 'Search projects by name, company, or tech...',
              hintStyle: TextStyle(
