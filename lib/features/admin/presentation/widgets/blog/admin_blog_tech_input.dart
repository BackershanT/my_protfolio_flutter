...
/// Interactive chip input widget for managing blog technologies/tags.
class AdminBlogTechInput extends StatefulWidget {
  final List<String> initialTechnologies;
  final ValueChanged<List<String>> onChanged;

  const AdminBlogTechInput({
    super.key,
  ...
  @override
  State<AdminBlogTechInput> createState() => _AdminBlogTechInputState();
}

class _AdminBlogTechInputState extends State<AdminBlogTechInput> {
    ...
    return Column(
      ...
      children: [
            ...
            Expanded(
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Add technology (e.g. Flutter, Supabase)...',
                  hintStyle: TextStyle(
        ...
        if (_technologies.isNotEmpty)
          ...
          Text(
            'No tags added yet. Type a technology and click +',
